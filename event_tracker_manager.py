    ...
    while True:
        ...
        if event == 'Create new Event Tracker':
            ...
            source_folder, source, geography, geopgraphy_folder, dest_file, folder_img, recalculate_value \
                = perfonitor.inputs.new_event_tracker()
...
"""
            ...
            all_irradiance_file, all_export_file, general_info_path = \
                perfonitor.data_acquisition.get_files_to_add(0, 0, geopgraphy_folder, geography, no_update=True)
...
"""
            ...
            df_active_eventtracker = perfonitor.data_treatment.match_df_to_event_tracker(df_all['Active Events'],
                                                                                         component_data, fmeca_data)
            df_closed_eventtracker = perfonitor.data_treatment.match_df_to_event_tracker(df_all['Closed Events'],
                                                                                         component_data, fmeca_data)
            df_active_eventtracker_trackers = perfonitor.data_treatment.match_df_to_event_tracker(
                df_all['Active tracker incidents'],
                tracker_data, fmeca_data, tracker=True)
            df_closed_eventtracker_trackers = perfonitor.data_treatment.match_df_to_event_tracker(
            ...
            dict_fmeca_shapes = perfonitor.data_treatment.create_fmeca_dataframes_for_validation(fmeca_data)
            ...
            final_df_to_add = perfonitor.calculations.active_hours_and_energy_lost_all_dfs(final_df_to_add,
        ...
        if event == 'Update Event Tracker':
            ...
            date_start, date_end, event_tracker_path, dmr_folder, geography, toggle_updt, recalculate_value \
                = perfonitor.inputs.update_event_tracker()
...
"""
            ...
            if toggle_updt == True:
                ...
                df_all_irradiance = perfonitor.file_creation.update_dump_file(irradiance_files, all_irradiance_file)
                df_all_export = perfonitor.file_creation.update_dump_file(export_files, all_export_file,
            ...
            # Get incidents' dataframes
            print("Reading incident and Event Tracker files and creating dataframes...")
            dfs_to_add, dfs_event_tracker, fmeca_data = perfonitor.data_acquisition.get_dataframes_to_add_to_EventTracker(
                report_files,
                event_tracker_path,
                fmeca_data,
                component_data,
            ...
            # Get final dfs to add
            print("Creating pre-treatment final dataframes of the Event tracker...")
            final_df_to_add = perfonitor.data_acquisition.get_final_dataframes_to_add_to_EventTracker(dfs_to_add,
                                                                                                      dfs_event_tracker,
                                                                                                      fmeca_data)
        ...
        if event == 'Event Tracker':
            ...
            # <editor-fold desc="Get inputs, files necessary to analysis">
            # Get input of critical information for update, dates and file locations
            source_folder, geography, geopgraphy_folder, recalculate_value = perfonitor.inputs.event_tracker()
...
"""
            ...
            # Calculate active hours and energy lost with correction for overlapping parents
            print("Creating final dataframes of the Event tracker...")
            final_df_to_add = perfonitor.calculations.active_hours_and_energy_lost_all_dfs(
        ...
        if event == 'Underperformance Report':
            ...
            perfonitor.file_creation.create_underperformance_report(underperformance_dest_file,
